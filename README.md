...
| --- | --- | ---: | ---: |
| Search | MRR@10 | >= 0.55 | 0.6223 |
| Search | NDCG@10 | >= 0.50 | 0.6823 |
| Search | Recall@10 | reference | 0.8693 |
| Search | p95 latency | <= 200 ms | 175.78 ms |
| Recommendation | Recall@300 | >= 0.30 | 0.6400 |
| Recommendation | HitRate@50 | >= 0.20 | 0.4650 |
| Recommendation | NDCG@50 | >= 0.08 | 0.2935 |
| Recommendation | Coverage@50 | >= 0.20 | 0.2037 |
| Recommendation | Ranking AUC | >= 0.70 | 0.8583 |
| Recommendation | Total p95 latency | <= 200 ms | 48.13 ms |
