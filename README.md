...
Multimodal search and multi-stage recommendation system for fashion commerce.
...
`apps/`, `src/mars/`, `scripts/`가 최종 runtime 기준입니다. `src/evaluation/`은 명세서의 `src/evaluation/metrics.py` 경로 요구를 만족시키기 위한 얇은 compatibility wrapper입니다.
